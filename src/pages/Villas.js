...
function Villas()
{
    ...
    const cocoDesc = "This villa is equipped with a dedicated footpath that leads to the sun-drenched beach with white shiny sand, allows you to expereince a stunning scene of early sunrise only a few steps away from your bedroom. You can bring even more friends or relatives along to stay in the villa's spacious three bedrooms";
